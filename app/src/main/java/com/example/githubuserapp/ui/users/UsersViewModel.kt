...
class UsersViewModel (
    ...
    private val _userList = MutableLiveData<ArrayList<GithubData>>()
    val userList: MutableLiveData<ArrayList<GithubData>> get() = _userList
    ...
    fun setUserList(list: ArrayList<GithubData>) {
